...
local REGISTRY = {
    ...
    { ns = "Ess.Player", usage = "Ess.Player.giveCash(i, n)",
      desc = "Gives player i cash, routed through the call that actually refreshes the HUD." },
    { ns = "Ess.Player", usage = "Ess.Player.giveFuel(i, n)",
      desc = "Gives player i fuel, routed through the call that actually refreshes the HUD." },
